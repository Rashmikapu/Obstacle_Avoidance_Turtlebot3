// Copyright 2023 Rashmi Kapu
/**
 * @file walker.cpp
 * @author Rashmi Kapu (rashmik@umd.edu)
 * @brief This node implements a class which creates a subscriber to the Lidar
 on Turtlebot4 burger and publisher to turtlebot3 burger. Based on the Lidar
 point cloud data, the node publishes velocities and orientations to the
 turtlebot accordingly, in order to avoid obstacles.
 * @version 0.1
 * @date 2023-11-29
 *
 * @copyright Copyright (c) 2023 Rashmi Kapu
 *
 */
